...
class ProfesseurSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','first_name','last_name','username','email','date_naissance', 'adresse', 'statut', 'universite',
                  ...
                  'classes_generales_enseignables','estActif',
                  'periode_journee','piece_jointe','ideleves'
                  ]
...
class ProfesseurSerializerWithToken(serializers.ModelSerializer):
    ...
    class Meta:
        model = Professeur
        fields = ['id','first_name','last_name','username','email','date_naissance', 'adresse', 'statut', 'universite',
                  'filiere_etude','annee_etude','dernier_diplome','sexe',
                  'filiere_dernier_diplome','jours_disponibles','matieres_generales_enseignables',
                  'classes_generales_enseignables','periode_journee','piece_jointe','ideleves','estActif',
                  'password','token'
                  ]
